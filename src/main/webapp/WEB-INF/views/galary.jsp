...
<body>
	...
	<form id="uploadfile" method="post" action="../uploadFiles" enctype="multipart/form-data">
		<input type="file" name="files" id="attFiles"  onchange="uploadDoc()" style="display: none" multiple>
	</form>
	...
	<script src="<c:url value="/resources/client_script/galary_cs.js" />"></script>
